...
import '../../data/repositories/taylor_repository_impl.dart';
import '../../domain/usecases/expand_taylor_series.dart';
import '../bloc/taylor_bloc.dart';

class TaylorPage extends StatelessWidget {
  const TaylorPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Taylor Series')),
      body: BlocProvider(
        create: (_) => TaylorBloc(
          expandTaylorSeries: ExpandTaylorSeries(TaylorRepositoryImpl()),
        ),
        child: const _TaylorBody(),
      ),
    );
  }
}

class _TaylorBody extends StatefulWidget {
  const _TaylorBody();

  @override
  State<_TaylorBody> createState() => _TaylorBodyState();
}

class _TaylorBodyState extends State<_TaylorBody> {
  ...
  void _calculate() {
    ...
    context.read<TaylorBloc>().add(ExpandTaylor(
