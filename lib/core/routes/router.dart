...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) => const DerivativePage(),
    ),
    GoRoute(
      path: AppRoutes.integrals,
      builder: (context, state) => const IntegralPage(),
    ),
    GoRoute(
      path: AppRoutes.limits,
      builder: (context, state) => const LimitPage(),
    ),
    GoRoute(
      path: AppRoutes.taylor,
      builder: (context, state) => const TaylorPage(),
    ),
    GoRoute(
      path: AppRoutes.dl,
      builder: (context, state) => const DLPage(),
    ),
    GoRoute(
